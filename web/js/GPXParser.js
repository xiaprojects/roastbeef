...
gpxParser.prototype.parse = function (gpxstring) {
    ...
    for (let idx in rtes){
        ...
        for (let idxIn in rtepts){
            ...
            pt.name   = keepThis.getElementValue(rtept, "name");
            pt.cmt   = keepThis.getElementValue(rtept, "cmt");
            pt.desc   = keepThis.getElementValue(rtept, "desc");
    ...
    for (let idx in trks){
	    ...
	    for (let idxIn in trkpts){
            ...
            pt.name   = keepThis.getElementValue(trkpt, "name");
            pt.cmt   = keepThis.getElementValue(trkpt, "cmt");
            pt.desc   = keepThis.getElementValue(trkpt, "desc");
