...
class FlightIndicators {
    ...
    updateCoordinator(turn,slipskid) {
        ...
        if(slipskid<-5)slipskid=-5;
        slipskid=slipskid/2;
        ball.style.transform = `translateX(${slipskid*15}px) rotate(${-slipskid*10}deg)`
    }
    ...
    createCoordinatorIndicator(imgDirectory) {
        ...
        const ball = this.createDivBox('ball', imgDirectory, 'turn_coordinator_slip_ball.svg')
